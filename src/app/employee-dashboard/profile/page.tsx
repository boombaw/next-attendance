...
import { BadgeQuestionMark, ChevronLeft, ChevronRight, LockIcon, LogOut, ShieldAlert, User, UserPen } from "lucide-react";
        ...
        <div className="relative flex h-screen w-full flex-col overflow-hidden max-w-md mx-auto bg-[#f6f7f8] dark:bg-[#101922] border-x border-slate-200 dark:border-slate-800">
            ...
            <div className="flex-1 overflow-y-auto pb-24 scrollbar-hide">
                ...
                <div className="px-4 py-2 mt-4 space-y-1">
                    <p className="px-2 pb-2 text-xs font-semibold text-slate-500 uppercase tracking-wider">{t.profile.setting}</p>
                    ...
                    <Link href="/employee-dashboard/profile/personal-info">
                        <div className="flex items-center gap-4 bg-white dark:bg-slate-900 px-4 py-3 rounded-xl justify-between cursor-pointer active:bg-slate-50 dark:active:bg-slate-800 transition-colors mb-2">
                            <div className="flex items-center gap-4">
                                ...
                                <p className="text-[#0d141b] dark:text-slate-100 text-[15px] font-medium leading-normal flex-1 truncate">{t.profile.personalInfo}</p>
                            </div>
                    ...
                    <Link href="/employee-dashboard/profile/change-password">
                        <div className="flex items-center gap-4 bg-white dark:bg-slate-900 px-4 py-3 rounded-xl justify-between cursor-pointer active:bg-slate-50 dark:active:bg-slate-800 transition-colors">
                            <div className="flex items-center gap-4">
                                ...
                                <p className="text-[#0d141b] dark:text-slate-100 text-[15px] font-medium leading-normal flex-1 truncate">{t.profile.changePassword}</p>
                            </div>
                            <div className="shrink-0">
                                <div className="text-slate-400 flex size-6 items-center justify-center">  
                                    <ChevronRight />
                ...
                <div className="px-4 py-2 mt-4 space-y-1">
                    <p className="px-2 pb-2 text-xs font-semibold text-slate-500 uppercase tracking-wider">{t.profile.support}</p>
                    ...
                    <div className="flex items-center gap-4 bg-white dark:bg-slate-900 px-4 py-3 rounded-xl justify-between cursor-pointer active:bg-slate-50 dark:active:bg-slate-800 transition-colors mb-2">
                        <div className="flex items-center gap-4">
                            ...
                            <p className="text-[#0d141b] dark:text-slate-100 text-[15px] font-medium leading-normal flex-1 truncate">{t.profile.helpCenter}</p>
                        </div>
                        <div className="shrink-0">
                            <div className="text-slate-400 flex size-6 items-center justify-center">
                                <ChevronRight />
                    ...
                    <div className="flex items-center gap-4 bg-white dark:bg-slate-900 px-4 py-3 rounded-xl justify-between cursor-pointer active:bg-slate-50 dark:active:bg-slate-800 transition-colors">
                        <div className="flex items-center gap-4">
                            ...
                            <p className="text-[#0d141b] dark:text-slate-100 text-[15px] font-medium leading-normal flex-1 truncate">{t.profile.privacyPolicy}</p>
                        </div>
                        <div className="shrink-0">
                            <div className="text-slate-400 flex size-6 items-center justify-center">
                                 <ChevronRight />
